      ...
      features={[
        {
          ...
          description: "Indulge in our exquisite tasting menus, meticulously crafted each season to showcase the freshest ingredients.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/top-view-woman-cuts-red-bell-pepper-cutting-board-with-parsley-tomatoes-basket-eggplants-wooden-background_141793-52119.jpg",
            imageAlt: "Chef preparing a delicate dish",
          },
          items: [
            {
              icon: Sparkles,
        ...
        {
          title: "Expert Wine Pairings",
          description: "Elevate your meal with our sommelier's expertly selected wine pairings, designed to complement each dish perfectly.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/woman-sitting-table-with-wine-glass_23-2147784077.jpg",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$48.00",
          imageSrc: "http://img.b2bpic.net/free-photo/dietary-salad-mix-sliced-turnips-served-wooden-platter-dark-colored-background-high-quality-photo_114579-64724.jpg",
          imageAlt: "Grilled Chilean sea bass with asparagus",
        },
        {
          id: "4",
          name: "Artisan Cheese Board",
          price: "$28.00",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-woman-decorating-pan-de-muerto-with-sugar_23-2149023952.jpg",
          imageAlt: "Artisan cheese board with fruits and nuts",
        },
        {
          id: "5",
          name: "Dark Chocolate Lava Cake",
          price: "$15.00",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-delicious-cookies-with-cup-coffee-biscuits-light-surface-dessert-sweet-cake-tea-horizontal-dough-sugar-biscuits_140725-158726.jpg",
        ...
        },
        {
          ...
          price: "$14.00",
          imageSrc: "http://img.b2bpic.net/free-photo/orange-juice-cocktail-table_140725-6757.jpg",
          imageAlt: "Fresh seasonal berry tart",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          handle: "@sarah_foodie",
          testimonial: "Olive & Thyme is an absolute gem! The truffle risotto was divine, and the service was impeccable. A truly unforgettable dining experience.",
        ...
        },
        {
          ...
          name: "Mark T.",
          handle: "@mark_eats",
          testimonial: "Every visit to Olive & Thyme feels like a special occasion. The pan-seared duck is a masterpiece, and their wine pairings are always spot on.",
          imageSrc: "http://img.b2bpic.net/free-photo/photo-handsome-man-hug-his-woman-while-drinking-wine_171337-18729.jpg",
          imageAlt: "Mark T.",
        },
        {
          id: "3",
          ...
          testimonial: "The atmosphere at Olive & Thyme is so inviting, and the food is consistently outstanding. Their seasonal berry tart is a must-try!",
          imageSrc: "http://img.b2bpic.net/free-photo/group-friends-enyoing-dinner-party_52683-130089.jpg",
          imageAlt: "Emily R.",
        },
        {
          id: "4",
          name: "David K.",
          handle: "@david_dines",
          testimonial: "From the appetizers to dessert, Olive & Thyme delivers perfection. The grilled sea bass was incredibly fresh and perfectly cooked.",
        ...
        },
        {
          ...
          name: "Jessica L.",
          handle: "@jessica_food",
          testimonial: "Our private dining event here was flawless. The customized menu was fantastic, and the attention to detail made it truly special.",
      ...
      faqs={[
        {
          ...
          content: "Yes, we highly recommend making a reservation, especially for dinner and weekend brunch. You can book a table directly through our website or by calling us.",
        },
        {
          id: "2",
          title: "Do you accommodate dietary restrictions?",
          content: "Absolutely. Please inform us of any dietary restrictions or allergies when making your reservation or upon arrival, and our chefs will do their best to accommodate.",
        },
        {
          id: "3",
          title: "Can I host a private event at Olive & Thyme?",
          content: "Yes, we offer private dining rooms perfect for intimate gatherings, corporate events, or celebrations. Please contact us to discuss your specific needs and our event packages.",
        },
      ]}
